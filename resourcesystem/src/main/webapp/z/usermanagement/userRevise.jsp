                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                            <h4 class="tittle-w3-agileits mb-4">修改用户</h4>
                            <form action="#" method="post">
                                <div class="form-group row">
                                    ...
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">权限</label>
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="inputEmail5"  required="">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">职位</label>
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="inputEmail6"  required="">
                                    </div>
